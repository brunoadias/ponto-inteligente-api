package com.dias.pontointeligente.api.security.controllers;
...
import com.dias.pontointeligente.api.security.dto.JwtAuthenticationDto;
import com.dias.pontointeligente.api.security.dto.TokenDto;
...
public class AuthenticationController {
	...
	public ResponseEntity<Response<TokenDto>> gerarRefreshTokenJwt(HttpServletRequest request) {
		...
		response.setDados(new TokenDto(refreshedToken));
		return ResponseEntity.ok(response);
	}
